    ...
    <nav className="sidebar">
      ...
      {(isCenter || isAdmin) && (
        <>
          ...
          <div
            className={`nav-item ${active("/entry/new") || active("/entry/edit") ? "active" : ""}`}
            onClick={() => go("/entry/new")}
          >
            <span className="nav-icon">✏️</span> New Survey
          </div>
          <div
            className={`nav-item ${active("/my-submissions") ? "active" : ""}`}
      ...
      {isAdmin && (
        <>
          ...
          <div
            className={`nav-item ${active("/master/disciplines") ? "active" : ""}`}
            onClick={() => go("/master/disciplines")}
          >
            <span className="nav-icon">🔬</span> Disciplines
          </div>
          <div
            className={`nav-item ${active("/master/seasons") ? "active" : ""}`}
            onClick={() => go("/master/seasons")}
          >
            <span className="nav-icon">🌦️</span> Seasons
          </div>
          <div
            className={`nav-item ${active("/master/soil-types") ? "active" : ""}`}
            onClick={() => go("/master/soil-types")}
          >
            <span className="nav-icon">🟤</span> Soil Types
          </div>
          <div
            className={`nav-item ${active("/master/previous-crops") ? "active" : ""}`}
            onClick={() => go("/master/previous-crops")}
          >
            <span className="nav-icon">🔄</span> Previous Crops
          </div>
          <div
            className={`nav-item ${active("/master/varieties") ? "active" : ""}`}
            onClick={() => go("/master/varieties")}
          >
            <span className="nav-icon">🏷️</span> Varieties
          </div>
          <div
            className={`nav-item ${active("/master/irrigation") ? "active" : ""}`}
            onClick={() => go("/master/irrigation")}
          >
            <span className="nav-icon">💧</span> Irrigation
          </div>
          <div
            className={`nav-item ${active("/master/crop-stages") ? "active" : ""}`}
            onClick={() => go("/master/crop-stages")}
          >
      ...
      <div className="sb-footer">
        ...
        {user?.centerName && (
          <div style={{ fontSize: 10, color: "rgba(255,255,255,.4)", marginTop: 1 }}>{user.centerName}</div>
        )}
        <div
          style={{
            marginTop: 8,
