...
import { SOIL_TYPES, PREVIOUS_CROPS, IRRIGATION_TYPES, SOWING_DATES, CROP_STAGES, PCT_OPTS, VARIETIES, getColsByDiscipline } from '../../utils/constants';
              ...
              <div style={{ marginBottom: 40 }}>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 24 }}>
                  <div className="form-group">
                    ...
                    <select className="p-input" style={{ width: '100%', padding: '12px', border: '1px solid #cbd5e1', borderRadius: 8 }} value={formData.soilType || ''} onChange={e => setFormData({...formData, soilType: e.target.value})}>
                  ...
                  <div className="form-group">
                    ...
                    <select className="p-input" style={{ width: '100%', padding: '12px', border: '1px solid #cbd5e1', borderRadius: 8 }} value={formData.previousCrop || ''} onChange={e => setFormData({...formData, previousCrop: e.target.value})}>
                      {PREVIOUS_CROPS.map(o => <option key={o}>{o}</option>)}
                    </select>
                  </div>
                  <div className="form-group">
                    <label className="p-label" style={{ display: 'block', marginBottom: 8, fontSize: 13, fontWeight: 700, color: '#64748b' }}>Variety</label>
                    <select className="p-input" style={{ width: '100%', padding: '12px', border: '1px solid #cbd5e1', borderRadius: 8 }} value={formData.variety || ''} onChange={e => setFormData({...formData, variety: e.target.value})}>
                      <option value="">— Select —</option>
                      {vars.map(o => <option key={o}>{o}</option>)}
                    </select>
